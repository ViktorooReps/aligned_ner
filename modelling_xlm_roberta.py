...
Copied from https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py
...
class XLMRobertaEncoder(nn.Module):
    def __init__(self, config):
        ...
        n_init_layers = config.num_hidden_layers - config.skip_last_layer
        self.layer = nn.ModuleList([XLMRobertaLayer(config) for _ in range(n_init_layers)])
